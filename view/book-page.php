            ...
            <div class="flex flex-col md:flex-row gap-8 h-full justify-between">
                ...
                <div class="w-full md:w-3/4 gap-4">
                    <div class="h-full flex flex-col justify-between gap-4">
                        ...
                        <!-- Action Buttons -->
                        <div class="w-full flex flex-col sm:flex-row justify-end gap-4 items-center">
                            <?php if(!checkIfBookAlreadyOwned($bookDetails['id'], $_SESSION['user_id'])){?>
                            <a href="?action=get" class="w-full sm:w-fit flex items-center justify-center gap-2 bg-[#0071E3] text-white px-6 py-2 rounded-md">
                            ...
                            <a href="?action=edit" class="w-full sm:w-fit flex items-center justify-center gap-2 bg-[#56C877] text-white px-6 py-2 rounded-md">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a href="?action=delete" class="w-full sm:w-fit flex items-center justify-center gap-2 bg-[#FE3A31] text-white px-6 py-2 rounded-md">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
