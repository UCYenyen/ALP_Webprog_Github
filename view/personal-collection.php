...
<body onload='makeBackgroundToFit()'>
    ...
    <div id="mobile-navbar" class="hidden fixed flex justify-between flex-col w-screen h-screen bg-[#F3F7FA]/90 backdrop-blur-sm p-12">
        <div class="p-4">
                ...
                if(!$isSearchingFavorite){
                    foreach($allOwnedBooks as $book){
                        if($book['is_favorite'] == 1){
                            ...
                            $bookId = $book['book_id'];
                ?>
                        <a href="?action=book-page-personal&id=<?= $bookId ?>" class="w-full h-full">
